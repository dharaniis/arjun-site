...
function PlanCard( { name, description, price, features }: PlanType) {
  return (
    <div className="font-sans w-84 md:w-md rounded-lg border shadow border-gray-600 bg-gray-950 transition-all duration-300 hover:scale-110">  
      <div className="m-10 flex flex-col gap-5 items-center justify-center ">        
              <h1 className="text-3xl text-red-600 goldman">{name}</h1>
              <p className="text-md md:text-xl text-gray-500 font-light ">{description}</p>
              <div className="">
